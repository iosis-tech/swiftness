...
pub fn eval_composition_polynomial_inner(
    ...
    let bitwise_sum_var_0_0 = column7_row1
        + column7_row17 * FELT_2
        + column7_row33 * FELT_4
        + column7_row49 * FELT_8
        + column7_row65 * FELT_18446744073709551616
        + column7_row81 * FELT_36893488147419103232
        + column7_row97 * FELT_73786976294838206464
        + column7_row113 * FELT_147573952589676412928;
    let bitwise_sum_var_8_0 = column7_row129 * FELT_340282366920938463463374607431768211456
        ...
        + column7_row161 * FELT_1361129467683753853853498429727072845824
        + column7_row177 * FELT_2722258935367507707706996859454145691648
        + column7_row193 * FELT_6277101735386680763835789423207666416102355444464034512896
        + column7_row209 * FELT_12554203470773361527671578846415332832204710888928069025792
        + column7_row225 * FELT_25108406941546723055343157692830665664409421777856138051584
        + column7_row241 * FELT_50216813883093446110686315385661331328818843555712276103168;
    ...
    let value = ((FELT_1 - cpu_decode_opcode_range_check_bit_9) * column8_row12
    ...
    let value = (column8_row10 - column8_row2 * column8_row12)
        * domain28.field_div(&felt_nonzero!(domain5));
    let total_sum = total_sum + constraint_coefficients[13] * value;

    // Constraint: cpu/update_registers/update_pc/pc_cond_negative.
    let value = ((FELT_1 - cpu_decode_opcode_range_check_bit_9) * column5_row16
    ...
    let value = (column8_row24
        - (cpu_decode_fp_update_regular_0 * column8_row8
            ...
            + cpu_decode_opcode_range_check_bit_12 * (column8_row0 + FELT_2)))
        * domain28.field_div(&felt_nonzero!(domain5));
    let total_sum = total_sum + constraint_coefficients[17] * value;

    // Constraint: cpu/opcodes/call/push_fp.
    let value = (cpu_decode_opcode_range_check_bit_12 * (column5_row9 - column8_row8))
        .field_div(&felt_nonzero!(domain5));
    ...
    let value = (cpu_decode_opcode_range_check_bit_12
        * (column5_row5 - (column5_row0 + cpu_decode_opcode_range_check_bit_2 + FELT_1)))
        .field_div(&felt_nonzero!(domain5));
    ...
    let value = (cpu_decode_opcode_range_check_bit_12
        * (column7_row8 - (global_values.half_offset_size + FELT_1)))
        .field_div(&felt_nonzero!(domain5));
    ...
    let value = (cpu_decode_opcode_range_check_bit_13
        * (column7_row0 + FELT_2 - global_values.half_offset_size))
        .field_div(&felt_nonzero!(domain5));
    let total_sum = total_sum + constraint_coefficients[23] * value;

    // Constraint: cpu/opcodes/ret/off2.
    let value = (cpu_decode_opcode_range_check_bit_13
        * (column7_row4 + FELT_1 - global_values.half_offset_size))
        .field_div(&felt_nonzero!(domain5));
    ...
    let value = (cpu_decode_opcode_range_check_bit_14 * (column5_row9 - column8_row12))
        .field_div(&felt_nonzero!(domain5));
    ...
    let value = ((global_values.memory_multi_column_perm_perm_interaction_elm
        ...
        * column9_inter1_row2
        - (global_values.memory_multi_column_perm_perm_interaction_elm
            ...
            * column9_inter1_row0)
        * domain30.field_div(&felt_nonzero!(domain1));
    ...
    let value = ((memory_address_diff_0 - FELT_1) * (column6_row1 - column6_row3))
        * domain30.field_div(&felt_nonzero!(domain1));
    ...
    let value = ((global_values.range_check16_perm_interaction_elm - column7_row6)
        ...
        * domain31.field_div(&felt_nonzero!(domain2));
    ...
    let value = ((global_values.diluted_check_permutation_interaction_elm - column7_row13)
        * column9_inter1_row15
        - (global_values.diluted_check_permutation_interaction_elm - column7_row9)
            * column9_inter1_row7)
        * domain32.field_div(&felt_nonzero!(domain3));
    ...
    let value =
        (column7_row5 - global_values.diluted_check_first_elm).field_div(&felt_nonzero!(domain29));
    ...
    let value = (column9_inter1_row3 - global_values.diluted_check_final_cum_val)
        .field_div(&felt_nonzero!(domain32));
    ...
    let value = (column8_row71 * (column3_row0 - (column3_row1 + column3_row1)))
    ...
    let value = (column4_row255 * (column3_row193 - FELT_8 * column3_row196))
        .field_div(&felt_nonzero!(domain8));
    ...
    let value =
        (column1_row0 - global_values.pedersen_shift_point.x).field_div(&felt_nonzero!(domain13));
    let total_sum = total_sum + constraint_coefficients[70] * value;

    // Constraint: pedersen/hash0/init/y.
    let value =
        (column2_row0 - global_values.pedersen_shift_point.y).field_div(&felt_nonzero!(domain13));
    ...
    let value =
        (column5_row518 - (column5_row134 + FELT_1)) * domain33.field_div(&felt_nonzero!(domain13));
    let total_sum = total_sum + constraint_coefficients[73] * value;

    // Constraint: pedersen/init_addr.
    let value =
        (column5_row6 - global_values.initial_pedersen_addr).field_div(&felt_nonzero!(domain29));
    ...
    let value =
        (column5_row326 - (column5_row70 + FELT_1)) * domain34.field_div(&felt_nonzero!(domain8));
    let total_sum = total_sum + constraint_coefficients[80] * value;

    // Constraint: range_check_builtin/init_addr.
    let value = (column5_row70 - global_values.initial_range_check_addr)
        .field_div(&felt_nonzero!(domain29));
    ...
    let value = (ecdsa_signature0_doubling_key_x_squared
        ...
        * domain21.field_div(&felt_nonzero!(domain6));
    ...
    let value = (ecdsa_signature0_exponentiate_generator_bit_0
        ...
        * domain25.field_div(&felt_nonzero!(domain7));
    ...
    let value = (column8_row7 * (column8_row27 - global_values.ecdsa_generator_points_x) - FELT_1)
        * domain25.field_div(&felt_nonzero!(domain7));
    ...
    let value = (column8_row51 * (column8_row17 - column8_row1) - FELT_1)
        * domain21.field_div(&felt_nonzero!(domain6));
    ...
    let value = (column8_row27 - global_values.ecdsa_sig_config.shift_point.x)
    ...
    let value = (column8_row91 + global_values.ecdsa_sig_config.shift_point.y)
        .field_div(&felt_nonzero!(domain27));
    let total_sum = total_sum + constraint_coefficients[104] * value;

    // Constraint: ecdsa/signature0/init_key/x.
    let value = (column8_row17 - global_values.ecdsa_sig_config.shift_point.x)
        .field_div(&felt_nonzero!(domain23));
    let total_sum = total_sum + constraint_coefficients[105] * value;

    // Constraint: ecdsa/signature0/init_key/y.
    let value = (column8_row49 - global_values.ecdsa_sig_config.shift_point.y)
        .field_div(&felt_nonzero!(domain23));
    ...
    let value = (column8_row32731 + column8_row16417
    ...
    let value = (column8_row32647 * (column8_row32667 - column8_row16337) - FELT_1)
        .field_div(&felt_nonzero!(domain27));
    let total_sum = total_sum + constraint_coefficients[110] * value;

    // Constraint: ecdsa/signature0/extract_r/slope.
    let value = (column8_row32753 + global_values.ecdsa_sig_config.shift_point.y
    ...
    let value =
        (column8_row32747 - column8_row1 * column8_row1).field_div(&felt_nonzero!(domain27));
    ...
    let value =
        (column5_row390 - global_values.initial_ecdsa_addr).field_div(&felt_nonzero!(domain29));
    ...
    let value = (column5_row33158 - (column5_row16774 + FELT_1))
        * domain35.field_div(&felt_nonzero!(domain27));
    ...
    let value =
        (column5_row198 - global_values.initial_bitwise_addr).field_div(&felt_nonzero!(domain29));
    let total_sum = total_sum + constraint_coefficients[123] * value;

    // Constraint: bitwise/step_var_pool_addr.
    let value =
        (column5_row454 - (column5_row198 + FELT_1)) * domain18.field_div(&felt_nonzero!(domain8));
    ...
    let value = ((column7_row705 + column7_row961) * FELT_16 - column7_row9)
    ...
    let value = ((column7_row721 + column7_row977) * FELT_16 - column7_row521)
        .field_div(&felt_nonzero!(domain19));
    let total_sum = total_sum + constraint_coefficients[131] * value;

    // Constraint: bitwise/unique_unpacking194.
    let value = ((column7_row737 + column7_row993) * FELT_16 - column7_row265)
        .field_div(&felt_nonzero!(domain19));
    let total_sum = total_sum + constraint_coefficients[132] * value;

    // Constraint: bitwise/unique_unpacking195.
    let value = ((column7_row753 + column7_row1009) * FELT_256 - column7_row777)
        .field_div(&felt_nonzero!(domain19));
    let total_sum = total_sum + constraint_coefficients[133] * value;

    // Constraint: ec_op/init_addr.
    let value =
        (column5_row8582 - global_values.initial_ec_op_addr).field_div(&felt_nonzero!(domain29));
    let total_sum = total_sum + constraint_coefficients[134] * value;

    // Constraint: ec_op/p_x_addr.
    let value = (column5_row24966 - (column5_row8582 + FELT_7))
        * domain37.field_div(&felt_nonzero!(domain23));
    ...
    let value = (column8_row16371 * (column8_row21 - (column8_row85 + column8_row85)))
        .field_div(&felt_nonzero!(domain23));
    ...
    let value = (column8_row16371
        * (column8_row85
            - FELT_3138550867693340381917894711603833208051177722232017256448 * column8_row12309))
        .field_div(&felt_nonzero!(domain23));
    ...
    let value = (column8_row16339 * (column8_row12373 - FELT_8 * column8_row12565))
        .field_div(&felt_nonzero!(domain23));
    ...
    let value = ((column8_row16085 - (column8_row16149 + column8_row16149))
        * (column8_row12629 - FELT_18014398509481984 * column8_row16085))
        .field_div(&felt_nonzero!(domain23));
    ...
    let value = (column8_row43 * (column8_row5 - column8_row41) - FELT_1)
        * domain21.field_div(&felt_nonzero!(domain6));
    ...
    let value =
        (column8_row6 * column8_row6 - column8_row14) * domain15.field_div(&felt_nonzero!(domain5));
    ...
    let value = (column8_row117
        ...
        * domain11.field_div(&felt_nonzero!(domain6));
    let total_sum = total_sum + constraint_coefficients[181] * value;

    // Constraint: poseidon/poseidon/full_round1.
    let value = (column8_row77 + poseidon_poseidon_full_rounds_state1_cubed_0
        - (poseidon_poseidon_full_rounds_state0_cubed_0
            + poseidon_poseidon_full_rounds_state2_cubed_0
    ...
    let value = (column5_row423 + poseidon_poseidon_full_rounds_state1_cubed_7
        - (poseidon_poseidon_full_rounds_state0_cubed_7
            + poseidon_poseidon_full_rounds_state2_cubed_7))
        .field_div(&felt_nonzero!(domain13));
