...
pub fn eval_composition_polynomial_inner(
	...
	let pow15 = trace_generator.pow_felt(&(((FELT_251 * global_values.trace_length).floor_div(&felt_nonzero!(FELT_256)))));
	let pow16 = trace_generator.pow_felt(&((global_values.trace_length.floor_div(&felt_nonzero!(FELT_2)))));
	let pow17 = trace_generator.pow_felt(&(((FELT_63 * global_values.trace_length).floor_div(&felt_nonzero!(FELT_64)))));
	let pow18 = trace_generator.pow_felt(&(((FELT_255 * global_values.trace_length).floor_div(&felt_nonzero!(FELT_256)))));
	let pow19 = trace_generator.pow_felt(&(((FELT_15 * global_values.trace_length).floor_div(&felt_nonzero!(FELT_16)))));
	...
	let range_check_builtin_value1_0 = range_check_builtin_value0_0 * global_values.offset_size + column0_row28;
	let range_check_builtin_value2_0 = range_check_builtin_value1_0 * global_values.offset_size + column0_row44;
	let range_check_builtin_value3_0 = range_check_builtin_value2_0 * global_values.offset_size + column0_row60;
	let range_check_builtin_value4_0 = range_check_builtin_value3_0 * global_values.offset_size + column0_row76;
	let range_check_builtin_value5_0 = range_check_builtin_value4_0 * global_values.offset_size + column0_row92;
	let range_check_builtin_value6_0 = range_check_builtin_value5_0 * global_values.offset_size + column0_row108;
	let range_check_builtin_value7_0 = range_check_builtin_value6_0 * global_values.offset_size + column0_row124;
	let ecdsa_signature0_doubling_key_x_squared = column21_row6 * column21_row6;
	let ecdsa_signature0_exponentiate_generator_bit_0 = column21_row15 - (column21_row47 + column21_row47);
	...
	let value = (cpu_decode_opcode_range_check_bit_0 * cpu_decode_opcode_range_check_bit_0 - cpu_decode_opcode_range_check_bit_0) * domain3.field_div(&felt_nonzero!(domain0));
	...
	let value = (column19_row1 - (((column1_row0 * global_values.offset_size + column0_row4) * global_values.offset_size + column0_row8) * global_values.offset_size + column0_row0)).field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[2] * value;
	
	// Constraint: cpu/decode/flag_op1_base_op0_bit.
	let value = (cpu_decode_flag_op1_base_op0_0 * cpu_decode_flag_op1_base_op0_0 - cpu_decode_flag_op1_base_op0_0).field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[3] * value;
	
	// Constraint: cpu/decode/flag_res_op1_bit.
	let value = (cpu_decode_flag_res_op1_0 * cpu_decode_flag_res_op1_0 - cpu_decode_flag_res_op1_0).field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[4] * value;
	
	// Constraint: cpu/decode/flag_pc_update_regular_bit.
	let value = (cpu_decode_flag_pc_update_regular_0 * cpu_decode_flag_pc_update_regular_0 - cpu_decode_flag_pc_update_regular_0).field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[5] * value;
	
	// Constraint: cpu/decode/fp_update_regular_bit.
	let value = (cpu_decode_fp_update_regular_0 * cpu_decode_fp_update_regular_0 - cpu_decode_fp_update_regular_0).field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[6] * value;
	
	// Constraint: cpu/operands/mem_dst_addr.
	let value = (column19_row8 + global_values.half_offset_size - (cpu_decode_opcode_range_check_bit_0 * column21_row8 + (FELT_1 - cpu_decode_opcode_range_check_bit_0) * column21_row0 + column0_row0)).field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[7] * value;
	
	// Constraint: cpu/operands/mem0_addr.
	let value = (column19_row4 + global_values.half_offset_size - (cpu_decode_opcode_range_check_bit_1 * column21_row8 + (FELT_1 - cpu_decode_opcode_range_check_bit_1) * column21_row0 + column0_row8)).field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[8] * value;
	
	// Constraint: cpu/operands/mem1_addr.
	let value = (column19_row12 + global_values.half_offset_size - (cpu_decode_opcode_range_check_bit_2 * column19_row0 + cpu_decode_opcode_range_check_bit_4 * column21_row0 + cpu_decode_opcode_range_check_bit_3 * column21_row8 + cpu_decode_flag_op1_base_op0_0 * column19_row5 + column0_row4)).field_div(&felt_nonzero!(domain4));
	...
	let value = ((FELT_1 - cpu_decode_opcode_range_check_bit_9) * column21_row12 - (cpu_decode_opcode_range_check_bit_5 * (column19_row5 + column19_row13) + cpu_decode_opcode_range_check_bit_6 * column21_row4 + cpu_decode_flag_res_op1_0 * column19_row13)).field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[11] * value;
	
	// Constraint: cpu/update_registers/update_pc/tmp0.
	let value = (column21_row2 - cpu_decode_opcode_range_check_bit_9 * column19_row9) * domain18.field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[12] * value;
	
	// Constraint: cpu/update_registers/update_pc/tmp1.
	let value = (column21_row10 - column21_row2 * column21_row12) * domain18.field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[13] * value;
	
	// Constraint: cpu/update_registers/update_pc/pc_cond_negative.
	let value = ((FELT_1 - cpu_decode_opcode_range_check_bit_9) * column19_row16 + column21_row2 * (column19_row16 - (column19_row0 + column19_row13)) - (cpu_decode_flag_pc_update_regular_0 * npc_reg_0 + cpu_decode_opcode_range_check_bit_7 * column21_row12 + cpu_decode_opcode_range_check_bit_8 * (column19_row0 + column21_row12))) * domain18.field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[14] * value;
	
	// Constraint: cpu/update_registers/update_pc/pc_cond_positive.
	let value = ((column21_row10 - cpu_decode_opcode_range_check_bit_9) * (column19_row16 - npc_reg_0)) * domain18.field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[15] * value;
	
	// Constraint: cpu/update_registers/update_ap/ap_update.
	let value = (column21_row16 - (column21_row0 + cpu_decode_opcode_range_check_bit_10 * column21_row12 + cpu_decode_opcode_range_check_bit_11 + cpu_decode_opcode_range_check_bit_12 * FELT_2)) * domain18.field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[16] * value;
	
	// Constraint: cpu/update_registers/update_fp/fp_update.
	let value = (column21_row24 - (cpu_decode_fp_update_regular_0 * column21_row8 + cpu_decode_opcode_range_check_bit_13 * column19_row9 + cpu_decode_opcode_range_check_bit_12 * (column21_row0 + FELT_2))) * domain18.field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[17] * value;
	
	// Constraint: cpu/opcodes/call/push_fp.
	let value = (cpu_decode_opcode_range_check_bit_12 * (column19_row9 - column21_row8)).field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[18] * value;
	
	// Constraint: cpu/opcodes/call/push_pc.
	let value = (cpu_decode_opcode_range_check_bit_12 * (column19_row5 - (column19_row0 + cpu_decode_opcode_range_check_bit_2 + FELT_1))).field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[19] * value;
	
	// Constraint: cpu/opcodes/call/off0.
	let value = (cpu_decode_opcode_range_check_bit_12 * (column0_row0 - global_values.half_offset_size)).field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[20] * value;
	
	// Constraint: cpu/opcodes/call/off1.
	let value = (cpu_decode_opcode_range_check_bit_12 * (column0_row8 - (global_values.half_offset_size + FELT_1))).field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[21] * value;
	
	// Constraint: cpu/opcodes/call/flags.
	let value = (cpu_decode_opcode_range_check_bit_12 * (cpu_decode_opcode_range_check_bit_12 + cpu_decode_opcode_range_check_bit_12 + FELT_1 + FELT_1 - (cpu_decode_opcode_range_check_bit_0 + cpu_decode_opcode_range_check_bit_1 + FELT_4))).field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[22] * value;
	
	// Constraint: cpu/opcodes/ret/off0.
	let value = (cpu_decode_opcode_range_check_bit_13 * (column0_row0 + FELT_2 - global_values.half_offset_size)).field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[23] * value;
	
	// Constraint: cpu/opcodes/ret/off2.
	let value = (cpu_decode_opcode_range_check_bit_13 * (column0_row4 + FELT_1 - global_values.half_offset_size)).field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[24] * value;
	
	// Constraint: cpu/opcodes/ret/flags.
	let value = (cpu_decode_opcode_range_check_bit_13 * (cpu_decode_opcode_range_check_bit_7 + cpu_decode_opcode_range_check_bit_0 + cpu_decode_opcode_range_check_bit_3 + cpu_decode_flag_res_op1_0 - FELT_4)).field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[25] * value;
	
	// Constraint: cpu/opcodes/assert_eq/assert_eq.
	let value = (cpu_decode_opcode_range_check_bit_14 * (column19_row9 - column21_row12)).field_div(&felt_nonzero!(domain4));
	...
	let value = (column24_inter1_row0 - global_values.memory_multi_column_perm_perm_public_memory_prod).field_div(&felt_nonzero!(domain20));
	let total_sum = total_sum + constraint_coefficients[35] * value;
	
	// Constraint: memory/diff_is_bit.
	let value = (memory_address_diff_0 * memory_address_diff_0 - memory_address_diff_0) * domain20.field_div(&felt_nonzero!(domain1));
	let total_sum = total_sum + constraint_coefficients[36] * value;
	
	// Constraint: memory/is_func.
	let value = ((memory_address_diff_0 - FELT_1) * (column20_row1 - column20_row3)) * domain20.field_div(&felt_nonzero!(domain1));
	...
	let value = ((global_values.range_check16_perm_interaction_elm - column2_row0) * column23_inter1_row0 + column0_row0 - global_values.range_check16_perm_interaction_elm).field_div(&felt_nonzero!(domain19));
	let total_sum = total_sum + constraint_coefficients[41] * value;
	
	// Constraint: range_check16/perm/step0.
	let value = ((global_values.range_check16_perm_interaction_elm - column2_row1) * column23_inter1_row1 - (global_values.range_check16_perm_interaction_elm - column0_row1) * column23_inter1_row0) * domain21.field_div(&felt_nonzero!(domain0));
	let total_sum = total_sum + constraint_coefficients[42] * value;
	
	// Constraint: range_check16/perm/last.
	let value = (column23_inter1_row0 - global_values.range_check16_perm_public_memory_prod).field_div(&felt_nonzero!(domain21));
	let total_sum = total_sum + constraint_coefficients[43] * value;
	
	// Constraint: range_check16/diff_is_bit.
	let value = (range_check16_diff_0 * range_check16_diff_0 - range_check16_diff_0) * domain21.field_div(&felt_nonzero!(domain0));
	...
	let value = (column16_row255 * (column5_row0 - (column5_row1 + column5_row1))).field_div(&felt_nonzero!(domain7));
	...
	let value = (column16_row255 * (column5_row1 - FELT_3138550867693340381917894711603833208051177722232017256448 * column5_row192)).field_div(&felt_nonzero!(domain7));
	...
	let value = (column16_row255 - column15_row255 * (column5_row192 - (column5_row193 + column5_row193))).field_div(&felt_nonzero!(domain7));
	...
	let value = (column15_row255 * (column5_row193 - FELT_8 * column5_row196)).field_div(&felt_nonzero!(domain7));
	...
	let value = (column15_row255 - (column5_row251 - (column5_row252 + column5_row252)) * (column5_row196 - (column5_row197 + column5_row197))).field_div(&felt_nonzero!(domain7));
	...
	let value = ((column5_row251 - (column5_row252 + column5_row252)) * (column5_row197 - FELT_18014398509481984 * column5_row251)).field_div(&felt_nonzero!(domain7));
	let total_sum = total_sum + constraint_coefficients[52] * value;
	
	// Constraint: pedersen/hash0/ec_subset_sum/booleanity_test.
	let value = (pedersen_hash0_ec_subset_sum_bit_0 * (pedersen_hash0_ec_subset_sum_bit_0 - FELT_1)) * domain8.field_div(&felt_nonzero!(domain0));
	...
	let value = (pedersen_hash0_ec_subset_sum_bit_0 * (column4_row0 - global_values.pedersen_points_y) - column15_row0 * (column3_row0 - global_values.pedersen_points_x)) * domain8.field_div(&felt_nonzero!(domain0));
	let total_sum = total_sum + constraint_coefficients[56] * value;
	
	// Constraint: pedersen/hash0/ec_subset_sum/add_points/x.
	let value = (column15_row0 * column15_row0 - pedersen_hash0_ec_subset_sum_bit_0 * (column3_row0 + global_values.pedersen_points_x + column3_row1)) * domain8.field_div(&felt_nonzero!(domain0));
	let total_sum = total_sum + constraint_coefficients[57] * value;
	
	// Constraint: pedersen/hash0/ec_subset_sum/add_points/y.
	let value = (pedersen_hash0_ec_subset_sum_bit_0 * (column4_row0 + column4_row1) - column15_row0 * (column3_row0 - column3_row1)) * domain8.field_div(&felt_nonzero!(domain0));
	let total_sum = total_sum + constraint_coefficients[58] * value;
	
	// Constraint: pedersen/hash0/ec_subset_sum/copy_point/x.
	let value = (pedersen_hash0_ec_subset_sum_bit_neg_0 * (column3_row1 - column3_row0)) * domain8.field_div(&felt_nonzero!(domain0));
	let total_sum = total_sum + constraint_coefficients[59] * value;
	
	// Constraint: pedersen/hash0/ec_subset_sum/copy_point/y.
	let value = (pedersen_hash0_ec_subset_sum_bit_neg_0 * (column4_row1 - column4_row0)) * domain8.field_div(&felt_nonzero!(domain0));
	...
	let value = (column3_row0 - global_values.pedersen_shift_point.x).field_div(&felt_nonzero!(domain11));
	let total_sum = total_sum + constraint_coefficients[63] * value;
	
	// Constraint: pedersen/hash0/init/y.
	let value = (column4_row0 - global_values.pedersen_shift_point.y).field_div(&felt_nonzero!(domain11));
	...
	let value = (column18_row255 * (column8_row0 - (column8_row1 + column8_row1))).field_div(&felt_nonzero!(domain7));
	...
	let value = (column18_row255 * (column8_row1 - FELT_3138550867693340381917894711603833208051177722232017256448 * column8_row192)).field_div(&felt_nonzero!(domain7));
	...
	let value = (column18_row255 - column17_row255 * (column8_row192 - (column8_row193 + column8_row193))).field_div(&felt_nonzero!(domain7));
	...
	let value = (column17_row255 * (column8_row193 - FELT_8 * column8_row196)).field_div(&felt_nonzero!(domain7));
	...
	let value = (column17_row255 - (column8_row251 - (column8_row252 + column8_row252)) * (column8_row196 - (column8_row197 + column8_row197))).field_div(&felt_nonzero!(domain7));
	...
	let value = ((column8_row251 - (column8_row252 + column8_row252)) * (column8_row197 - FELT_18014398509481984 * column8_row251)).field_div(&felt_nonzero!(domain7));
	let total_sum = total_sum + constraint_coefficients[70] * value;
	
	// Constraint: pedersen/hash1/ec_subset_sum/booleanity_test.
	let value = (pedersen_hash1_ec_subset_sum_bit_0 * (pedersen_hash1_ec_subset_sum_bit_0 - FELT_1)) * domain8.field_div(&felt_nonzero!(domain0));
	...
	let value = (pedersen_hash1_ec_subset_sum_bit_0 * (column7_row0 - global_values.pedersen_points_y) - column16_row0 * (column6_row0 - global_values.pedersen_points_x)) * domain8.field_div(&felt_nonzero!(domain0));
	let total_sum = total_sum + constraint_coefficients[74] * value;
	
	// Constraint: pedersen/hash1/ec_subset_sum/add_points/x.
	let value = (column16_row0 * column16_row0 - pedersen_hash1_ec_subset_sum_bit_0 * (column6_row0 + global_values.pedersen_points_x + column6_row1)) * domain8.field_div(&felt_nonzero!(domain0));
	let total_sum = total_sum + constraint_coefficients[75] * value;
	
	// Constraint: pedersen/hash1/ec_subset_sum/add_points/y.
	let value = (pedersen_hash1_ec_subset_sum_bit_0 * (column7_row0 + column7_row1) - column16_row0 * (column6_row0 - column6_row1)) * domain8.field_div(&felt_nonzero!(domain0));
	let total_sum = total_sum + constraint_coefficients[76] * value;
	
	// Constraint: pedersen/hash1/ec_subset_sum/copy_point/x.
	let value = (pedersen_hash1_ec_subset_sum_bit_neg_0 * (column6_row1 - column6_row0)) * domain8.field_div(&felt_nonzero!(domain0));
	let total_sum = total_sum + constraint_coefficients[77] * value;
	
	// Constraint: pedersen/hash1/ec_subset_sum/copy_point/y.
	let value = (pedersen_hash1_ec_subset_sum_bit_neg_0 * (column7_row1 - column7_row0)) * domain8.field_div(&felt_nonzero!(domain0));
	...
	let value = (column6_row0 - global_values.pedersen_shift_point.x).field_div(&felt_nonzero!(domain11));
	let total_sum = total_sum + constraint_coefficients[81] * value;
	
	// Constraint: pedersen/hash1/init/y.
	let value = (column7_row0 - global_values.pedersen_shift_point.y).field_div(&felt_nonzero!(domain11));
	...
	let value = (column22_row144 * (column11_row0 - (column11_row1 + column11_row1))).field_div(&felt_nonzero!(domain7));
	...
	let value = (column22_row144 * (column11_row1 - FELT_3138550867693340381917894711603833208051177722232017256448 * column11_row192)).field_div(&felt_nonzero!(domain7));
	...
	let value = (column22_row144 - column22_row16 * (column11_row192 - (column11_row193 + column11_row193))).field_div(&felt_nonzero!(domain7));
	...
	let value = (column22_row16 * (column11_row193 - FELT_8 * column11_row196)).field_div(&felt_nonzero!(domain7));
	...
	let value = (column22_row16 - (column11_row251 - (column11_row252 + column11_row252)) * (column11_row196 - (column11_row197 + column11_row197))).field_div(&felt_nonzero!(domain7));
	...
	let value = ((column11_row251 - (column11_row252 + column11_row252)) * (column11_row197 - FELT_18014398509481984 * column11_row251)).field_div(&felt_nonzero!(domain7));
	let total_sum = total_sum + constraint_coefficients[88] * value;
	
	// Constraint: pedersen/hash2/ec_subset_sum/booleanity_test.
	let value = (pedersen_hash2_ec_subset_sum_bit_0 * (pedersen_hash2_ec_subset_sum_bit_0 - FELT_1)) * domain8.field_div(&felt_nonzero!(domain0));
	...
	let value = (pedersen_hash2_ec_subset_sum_bit_0 * (column10_row0 - global_values.pedersen_points_y) - column17_row0 * (column9_row0 - global_values.pedersen_points_x)) * domain8.field_div(&felt_nonzero!(domain0));
	let total_sum = total_sum + constraint_coefficients[92] * value;
	
	// Constraint: pedersen/hash2/ec_subset_sum/add_points/x.
	let value = (column17_row0 * column17_row0 - pedersen_hash2_ec_subset_sum_bit_0 * (column9_row0 + global_values.pedersen_points_x + column9_row1)) * domain8.field_div(&felt_nonzero!(domain0));
	let total_sum = total_sum + constraint_coefficients[93] * value;
	
	// Constraint: pedersen/hash2/ec_subset_sum/add_points/y.
	let value = (pedersen_hash2_ec_subset_sum_bit_0 * (column10_row0 + column10_row1) - column17_row0 * (column9_row0 - column9_row1)) * domain8.field_div(&felt_nonzero!(domain0));
	let total_sum = total_sum + constraint_coefficients[94] * value;
	
	// Constraint: pedersen/hash2/ec_subset_sum/copy_point/x.
	let value = (pedersen_hash2_ec_subset_sum_bit_neg_0 * (column9_row1 - column9_row0)) * domain8.field_div(&felt_nonzero!(domain0));
	let total_sum = total_sum + constraint_coefficients[95] * value;
	
	// Constraint: pedersen/hash2/ec_subset_sum/copy_point/y.
	let value = (pedersen_hash2_ec_subset_sum_bit_neg_0 * (column10_row1 - column10_row0)) * domain8.field_div(&felt_nonzero!(domain0));
	...
	let value = (column9_row0 - global_values.pedersen_shift_point.x).field_div(&felt_nonzero!(domain11));
	let total_sum = total_sum + constraint_coefficients[99] * value;
	
	// Constraint: pedersen/hash2/init/y.
	let value = (column10_row0 - global_values.pedersen_shift_point.y).field_div(&felt_nonzero!(domain11));
	...
	let value = (column22_row208 * (column14_row0 - (column14_row1 + column14_row1))).field_div(&felt_nonzero!(domain7));
	...
	let value = (column22_row208 * (column14_row1 - FELT_3138550867693340381917894711603833208051177722232017256448 * column14_row192)).field_div(&felt_nonzero!(domain7));
	...
	let value = (column22_row208 - column22_row80 * (column14_row192 - (column14_row193 + column14_row193))).field_div(&felt_nonzero!(domain7));
	...
	let value = (column22_row80 * (column14_row193 - FELT_8 * column14_row196)).field_div(&felt_nonzero!(domain7));
	...
	let value = (column22_row80 - (column14_row251 - (column14_row252 + column14_row252)) * (column14_row196 - (column14_row197 + column14_row197))).field_div(&felt_nonzero!(domain7));
	...
	let value = ((column14_row251 - (column14_row252 + column14_row252)) * (column14_row197 - FELT_18014398509481984 * column14_row251)).field_div(&felt_nonzero!(domain7));
	let total_sum = total_sum + constraint_coefficients[106] * value;
	
	// Constraint: pedersen/hash3/ec_subset_sum/booleanity_test.
	let value = (pedersen_hash3_ec_subset_sum_bit_0 * (pedersen_hash3_ec_subset_sum_bit_0 - FELT_1)) * domain8.field_div(&felt_nonzero!(domain0));
	...
	let value = (pedersen_hash3_ec_subset_sum_bit_0 * (column13_row0 - global_values.pedersen_points_y) - column18_row0 * (column12_row0 - global_values.pedersen_points_x)) * domain8.field_div(&felt_nonzero!(domain0));
	let total_sum = total_sum + constraint_coefficients[110] * value;
	
	// Constraint: pedersen/hash3/ec_subset_sum/add_points/x.
	let value = (column18_row0 * column18_row0 - pedersen_hash3_ec_subset_sum_bit_0 * (column12_row0 + global_values.pedersen_points_x + column12_row1)) * domain8.field_div(&felt_nonzero!(domain0));
	let total_sum = total_sum + constraint_coefficients[111] * value;
	
	// Constraint: pedersen/hash3/ec_subset_sum/add_points/y.
	let value = (pedersen_hash3_ec_subset_sum_bit_0 * (column13_row0 + column13_row1) - column18_row0 * (column12_row0 - column12_row1)) * domain8.field_div(&felt_nonzero!(domain0));
	let total_sum = total_sum + constraint_coefficients[112] * value;
	
	// Constraint: pedersen/hash3/ec_subset_sum/copy_point/x.
	let value = (pedersen_hash3_ec_subset_sum_bit_neg_0 * (column12_row1 - column12_row0)) * domain8.field_div(&felt_nonzero!(domain0));
	let total_sum = total_sum + constraint_coefficients[113] * value;
	
	// Constraint: pedersen/hash3/ec_subset_sum/copy_point/y.
	let value = (pedersen_hash3_ec_subset_sum_bit_neg_0 * (column13_row1 - column13_row0)) * domain8.field_div(&felt_nonzero!(domain0));
	...
	let value = (column12_row0 - global_values.pedersen_shift_point.x).field_div(&felt_nonzero!(domain11));
	let total_sum = total_sum + constraint_coefficients[117] * value;
	
	// Constraint: pedersen/hash3/init/y.
	let value = (column13_row0 - global_values.pedersen_shift_point.y).field_div(&felt_nonzero!(domain11));
	...
	let value = (column19_row134 - (column19_row38 + FELT_1)) * domain22.field_div(&felt_nonzero!(domain6));
	let total_sum = total_sum + constraint_coefficients[123] * value;
	
	// Constraint: pedersen/init_addr.
	let value = (column19_row6 - global_values.initial_pedersen_addr).field_div(&felt_nonzero!(domain19));
	...
	let value = (column19_row230 - (column19_row102 + FELT_1)) * domain22.field_div(&felt_nonzero!(domain6));
	let total_sum = total_sum + constraint_coefficients[136] * value;
	
	// Constraint: range_check_builtin/init_addr.
	let value = (column19_row102 - global_values.initial_range_check_addr).field_div(&felt_nonzero!(domain19));
	let total_sum = total_sum + constraint_coefficients[137] * value;
	
	// Constraint: ecdsa/signature0/doubling_key/slope.
	let value = (ecdsa_signature0_doubling_key_x_squared + ecdsa_signature0_doubling_key_x_squared + ecdsa_signature0_doubling_key_x_squared + global_values.ecdsa_sig_config.alpha - (column21_row14 + column21_row14) * column21_row13) * domain12.field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[138] * value;
	
	// Constraint: ecdsa/signature0/doubling_key/x.
	let value = (column21_row13 * column21_row13 - (column21_row6 + column21_row6 + column21_row22)) * domain12.field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[139] * value;
	
	// Constraint: ecdsa/signature0/doubling_key/y.
	let value = (column21_row14 + column21_row30 - column21_row13 * (column21_row6 - column21_row22)) * domain12.field_div(&felt_nonzero!(domain4));
	...
	let value = (ecdsa_signature0_exponentiate_generator_bit_0 * (ecdsa_signature0_exponentiate_generator_bit_0 - FELT_1)) * domain15.field_div(&felt_nonzero!(domain5));
	...
	let value = (ecdsa_signature0_exponentiate_generator_bit_0 * (column21_row23 - global_values.ecdsa_generator_points_y) - column21_row31 * (column21_row7 - global_values.ecdsa_generator_points_x)) * domain15.field_div(&felt_nonzero!(domain5));
	let total_sum = total_sum + constraint_coefficients[144] * value;
	
	// Constraint: ecdsa/signature0/exponentiate_generator/add_points/x.
	let value = (column21_row31 * column21_row31 - ecdsa_signature0_exponentiate_generator_bit_0 * (column21_row7 + global_values.ecdsa_generator_points_x + column21_row39)) * domain15.field_div(&felt_nonzero!(domain5));
	let total_sum = total_sum + constraint_coefficients[145] * value;
	
	// Constraint: ecdsa/signature0/exponentiate_generator/add_points/y.
	let value = (ecdsa_signature0_exponentiate_generator_bit_0 * (column21_row23 + column21_row55) - column21_row31 * (column21_row7 - column21_row39)) * domain15.field_div(&felt_nonzero!(domain5));
	...
	let value = (column22_row0 * (column21_row7 - global_values.ecdsa_generator_points_x) - FELT_1) * domain15.field_div(&felt_nonzero!(domain5));
	let total_sum = total_sum + constraint_coefficients[147] * value;
	
	// Constraint: ecdsa/signature0/exponentiate_generator/copy_point/x.
	let value = (ecdsa_signature0_exponentiate_generator_bit_neg_0 * (column21_row39 - column21_row7)) * domain15.field_div(&felt_nonzero!(domain5));
	let total_sum = total_sum + constraint_coefficients[148] * value;
	
	// Constraint: ecdsa/signature0/exponentiate_generator/copy_point/y.
	let value = (ecdsa_signature0_exponentiate_generator_bit_neg_0 * (column21_row55 - column21_row23)) * domain15.field_div(&felt_nonzero!(domain5));
	let total_sum = total_sum + constraint_coefficients[149] * value;
	
	// Constraint: ecdsa/signature0/exponentiate_key/booleanity_test.
	let value = (ecdsa_signature0_exponentiate_key_bit_0 * (ecdsa_signature0_exponentiate_key_bit_0 - FELT_1)) * domain12.field_div(&felt_nonzero!(domain4));
	...
	let value = (ecdsa_signature0_exponentiate_key_bit_0 * (column21_row9 - column21_row14) - column21_row3 * (column21_row1 - column21_row6)) * domain12.field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[153] * value;
	
	// Constraint: ecdsa/signature0/exponentiate_key/add_points/x.
	let value = (column21_row3 * column21_row3 - ecdsa_signature0_exponentiate_key_bit_0 * (column21_row1 + column21_row6 + column21_row17)) * domain12.field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[154] * value;
	
	// Constraint: ecdsa/signature0/exponentiate_key/add_points/y.
	let value = (ecdsa_signature0_exponentiate_key_bit_0 * (column21_row9 + column21_row25) - column21_row3 * (column21_row1 - column21_row17)) * domain12.field_div(&felt_nonzero!(domain4));
	...
	let value = (column21_row11 * (column21_row1 - column21_row6) - FELT_1) * domain12.field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[156] * value;
	
	// Constraint: ecdsa/signature0/exponentiate_key/copy_point/x.
	let value = (ecdsa_signature0_exponentiate_key_bit_neg_0 * (column21_row17 - column21_row1)) * domain12.field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[157] * value;
	
	// Constraint: ecdsa/signature0/exponentiate_key/copy_point/y.
	let value = (ecdsa_signature0_exponentiate_key_bit_neg_0 * (column21_row25 - column21_row9)) * domain12.field_div(&felt_nonzero!(domain4));
	let total_sum = total_sum + constraint_coefficients[158] * value;
	
	// Constraint: ecdsa/signature0/init_gen/x.
	let value = (column21_row7 - global_values.ecdsa_sig_config.shift_point.x).field_div(&felt_nonzero!(domain17));
	let total_sum = total_sum + constraint_coefficients[159] * value;
	
	// Constraint: ecdsa/signature0/init_gen/y.
	let value = (column21_row23 + global_values.ecdsa_sig_config.shift_point.y).field_div(&felt_nonzero!(domain17));
	let total_sum = total_sum + constraint_coefficients[160] * value;
	
	// Constraint: ecdsa/signature0/init_key/x.
	let value = (column21_row1 - global_values.ecdsa_sig_config.shift_point.x).field_div(&felt_nonzero!(domain14));
	let total_sum = total_sum + constraint_coefficients[161] * value;
	
	// Constraint: ecdsa/signature0/init_key/y.
	let value = (column21_row9 - global_values.ecdsa_sig_config.shift_point.y).field_div(&felt_nonzero!(domain14));
	let total_sum = total_sum + constraint_coefficients[162] * value;
	
	// Constraint: ecdsa/signature0/add_results/slope.
	let value = (column21_row8183 - (column21_row4089 + column21_row8191 * (column21_row8167 - column21_row4081))).field_div(&felt_nonzero!(domain17));
	let total_sum = total_sum + constraint_coefficients[163] * value;
	
	// Constraint: ecdsa/signature0/add_results/x.
	let value = (column21_row8191 * column21_row8191 - (column21_row8167 + column21_row4081 + column21_row4102)).field_div(&felt_nonzero!(domain17));
	let total_sum = total_sum + constraint_coefficients[164] * value;
	
	// Constraint: ecdsa/signature0/add_results/y.
	let value = (column21_row8183 + column21_row4110 - column21_row8191 * (column21_row8167 - column21_row4102)).field_div(&felt_nonzero!(domain17));
	let total_sum = total_sum + constraint_coefficients[165] * value;
	
	// Constraint: ecdsa/signature0/add_results/x_diff_inv.
	let value = (column22_row8160 * (column21_row8167 - column21_row4081) - FELT_1).field_div(&felt_nonzero!(domain17));
	let total_sum = total_sum + constraint_coefficients[166] * value;
	
	// Constraint: ecdsa/signature0/extract_r/slope.
	let value = (column21_row8185 + global_values.ecdsa_sig_config.shift_point.y - column21_row4083 * (column21_row8177 - global_values.ecdsa_sig_config.shift_point.x)).field_div(&felt_nonzero!(domain17));
	let total_sum = total_sum + constraint_coefficients[167] * value;
	
	// Constraint: ecdsa/signature0/extract_r/x.
	let value = (column21_row4083 * column21_row4083 - (column21_row8177 + global_values.ecdsa_sig_config.shift_point.x + column21_row5)).field_div(&felt_nonzero!(domain17));
	let total_sum = total_sum + constraint_coefficients[168] * value;
	
	// Constraint: ecdsa/signature0/extract_r/x_diff_inv.
	let value = (column21_row8179 * (column21_row8177 - global_values.ecdsa_sig_config.shift_point.x) - FELT_1).field_div(&felt_nonzero!(domain17));
	...
	let value = (column21_row8187 - column21_row6 * column21_row6).field_div(&felt_nonzero!(domain17));
	let total_sum = total_sum + constraint_coefficients[172] * value;
	
	// Constraint: ecdsa/signature0/q_on_curve/on_curve.
	let value = (column21_row14 * column21_row14 - (column21_row6 * column21_row8187 + global_values.ecdsa_sig_config.alpha * column21_row6 + global_values.ecdsa_sig_config.beta)).field_div(&felt_nonzero!(domain17));
	let total_sum = total_sum + constraint_coefficients[173] * value;
	
	// Constraint: ecdsa/init_addr.
	let value = (column19_row22 - global_values.initial_ecdsa_addr).field_div(&felt_nonzero!(domain19));
	...
	let value = (column19_row8214 - (column19_row4118 + FELT_1)) * domain23.field_div(&felt_nonzero!(domain17));
