...
pub fn get() -> StarkWitness {
    return StarkWitness {
        traces_decommitment:
            cairovm_verifier_air::layout::recursive::tests::trace_decommitment::get(),
        traces_witness: cairovm_verifier_air::layout::recursive::tests::trace_witness::get(),
        ...
        composition_witness: table::types::Witness {
        ...
        fri_witness: cairovm_verifier_fri::tests::witness::get(),
    };
}
